...
*   1) Call the yi178() function in autotest-validate.c to get your hard coded username.
...
void test_validate_my_username()
{
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(username_from_code, username_from_file, "用户名不匹配！");
